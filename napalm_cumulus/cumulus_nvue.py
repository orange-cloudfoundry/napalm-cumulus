# Copyright 2023 Network To Code llc. All rights reserved.
#
...
"""
Napalm driver for Cumulus NVUE (5.x).
...
class CumulusNVUEDriver(NetworkDriver):
    """Napalm driver for Cumulus NVUE."""
    ...
    def compare_config(self):
        if self.loaded:
            diff = self._send_command('nv config pending')
